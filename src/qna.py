...
Then, write a cypher query to retrieve all information, all nodes, all relations, all properties related to all the keywords from the graph database. Follow the graph node name, relationship name, property name properly according to schema. Also look for partial matches by using contains, lower, regex, starts_with etc.
